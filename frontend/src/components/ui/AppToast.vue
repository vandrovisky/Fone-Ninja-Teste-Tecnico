...
<template>
  <div class="fixed bottom-4 right-4 z-[9999] flex flex-col gap-2 min-w-[320px] max-w-md">
    <TransitionGroup 
    ...
    >
      <div 
        ...
        :key="toast.id"
        :class="['flex items-start p-4 rounded-xl border shadow-lg backdrop-blur-sm', styles[toast.type]]"
      >
